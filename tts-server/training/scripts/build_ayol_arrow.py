# ayol_f5/metadata_abs.csv -> F5 arrow (data/ayol_char/). 1571110404 dedicated dataset.
...
CSV = r"C:/Projects/nexttts/tts-server/training/data/ayol_f5/metadata_abs.csv"
OUT = Path(str(files("f5_tts").joinpath("../../data"))).resolve() / "ayol_char"
