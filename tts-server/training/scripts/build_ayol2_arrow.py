# ayol2_f5/metadata_abs.csv (fonema-vaznli) -> F5 arrow (data/ayol2_char/).
...
CSV = r"C:/Projects/nexttts/tts-server/training/data/ayol2_f5/metadata_abs.csv"
OUT = Path(str(files("f5_tts").joinpath("../../data"))).resolve() / "ayol2_char"
