# uzbek100_f5/metadata_abs.csv -> F5 arrow (data/uzbek100_char/). To'liq ISSAI dataseti.
...
CSV = r"C:/Projects/nexttts/tts-server/training/data/uzbek100_f5/metadata_abs.csv"
OUT = Path(str(files("f5_tts").joinpath("../../data"))).resolve() / "uzbek100_char"
