...
import { Moon, Sun, Mic, Download, Activity, Sparkles, GitCompare } from "lucide-react";
...
const PAGE_TITLES: Record<string, { title: string; subtitle: string }> = {
  ...
  "/voice-lab": { title: "Voice Lab", subtitle: "Yangi matn — checkpoint sinov" },
  "/compare": { title: "Solishtirish", subtitle: "Tayyor namunalar A/B/C/D" },
